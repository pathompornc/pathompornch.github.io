...
export const experienceData = [
  {
    ...
    description: [
      ...
      "Increased product adoption by 45% and reduced churn by 30% through strategic product improvements and enhanced user experience."
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Grew monthly active users by 150% and improved customer satisfaction scores from 7.2 to 9.1."
    ],
  ...
  },
  {
    ...
    description: [
      ...
      "Collaborated with marketing teams to implement personalized email campaigns that generated $2.5M in additional revenue."
    ],
