...
export const projectData = [
  {
    ...
    context: "The e-commerce platform was experiencing low conversion rates and customer engagement. Users were struggling to find relevant products, resulting in high bounce rates and abandoned carts.",
  ...
  {
    id: "customer-segmentation-platform",
